...
// AND that are tied to active employees:
$sqlCommand = "SELECT R.request_id, R.employee_id, R.start_date, R.end_date, R.start_time, R.end_time FROM subway.request R, subway.employee E where R.end_date >= CURDATE() and R.employee_id = E.employee_id";
$result = mysqli_query($db_connect, $sqlCommand);
